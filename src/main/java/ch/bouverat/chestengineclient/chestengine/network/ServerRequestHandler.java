...
public class ServerRequestHandler {
    ...
    public Pawn[][] boardUpdateRequest() {
        ...
        newBoard[0][1] = new Pawn(0, 1, "BK1", PawnType.KNIGHT, PawnColor.BLACK);
        ...
        newBoard[0][6] = new Pawn(0, 6, "BK2", PawnType.KNIGHT, PawnColor.BLACK);
        newBoard[0][7] = new Pawn(0, 7, "BR2", PawnType.ROOK, PawnColor.BLACK);

        newBoard[7][0] = new Pawn(7, 0, "WR1", PawnType.ROOK, PawnColor.WHITE);
        newBoard[7][1] = new Pawn(7, 1, "WK1", PawnType.KNIGHT, PawnColor.WHITE);
        ...
        newBoard[7][6] = new Pawn(7, 6, "WK2", PawnType.KNIGHT, PawnColor.WHITE);
